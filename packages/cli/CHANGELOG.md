...
- 428d1f5: Telemetry no longer prints PostHog network stack traces when the endpoint is unreachable, and adds an `ossperks telemetry status|enable|disable` command.
