...
Elegibilidade em 48 programas — 12 elegíveis, 8 precisam de revisão, 28 inelegíveis
  ...
  ✅  Vercel for Open Source                         Provavelmente elegível — projeto open source
  ✅  Netlify Open Source Plan                      Provavelmente elegível — projeto open source
  ⚠️  GitHub Copilot Pro for Open Source Maintainers Precisa de revisão — revisão manual necessária
  ❌  DigitalOcean Open Source Credits             Provavelmente inelegível — estrelas no GitHub insuficientes
```
...
- **❌ Provavelmente inelegível** — uma ou mais regras claramente não foram atendidas
