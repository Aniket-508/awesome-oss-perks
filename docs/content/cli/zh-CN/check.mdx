...
| `-p, --program <id>`    | 仅检查特定项目（例如 `--program vercel`）              |
| `--json`                | 输出原始 JSON                                                              |
| `-h, --help`            | 显示帮助                                                                    |
...
```
✅ my-project — MIT · 412 stars · 3 天前最后推送

48 个项目的资格审查 — 12 个符合条件，8 个需要审核，28 个不符合条件
  ...
  ❌  DigitalOcean Open Source Credits             可能不符合条件 — GitHub stars 数量不足
```
