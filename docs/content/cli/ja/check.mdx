...
| `-p, --program <slug>`  | 特定のプログラムのみをチェック (例: `--program vercel`)                                |
| `--json`                | 生のJSONを出力                                                                         |
| `-h, --help`            | ヘルプを表示                                                                           |
...
48プログラムでの適格性 — 12件適格、8件要確認、28件不適格

  ✅  vercel                 適格の可能性あり — オープンソースプロジェクト
  ✅  netlify                適格の可能性あり — オープンソースプロジェクト
  ⚠️  github-copilot         要確認 — 手動レビューが必要
  ❌  aws-activate           不適格の可能性あり — 1000スターが必要
```

ステータス:

- **✅ 適格の可能性あり** — 解析されたすべての適格性ルールに一致
