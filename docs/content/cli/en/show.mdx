...
| -------- | --------------------------------------------- |
| `<id>`   | The program id (e.g. `vercel`, `github-pages`) |
...
Find a program id in the **ID** column from <DynamicLink href="/[lang]/cli/list">`ossperks list`</DynamicLink> or <DynamicLink href="/[lang]/cli/search">`ossperks search`</DynamicLink>.
