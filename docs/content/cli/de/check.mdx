...
Zulässigkeit über 48 Programme — 12 zulässig, 8 benötigen Überprüfung, 28 nicht zulässig

  ✅  vercel                 Wahrscheinlich zulässig — Open-Source-Projekt
  ✅  netlify                Wahrscheinlich zulässig — Open-Source-Projekt
  ⚠️  github-copilot         Überprüfung erforderlich — manuelle Überprüfung nötig
  ❌  aws-activate           Wahrscheinlich nicht zulässig — erfordert 1000 Sterne
```

Status:

- **✅ Wahrscheinlich zulässig** — alle analysierten Zulassungsregeln erfüllt
- **⚠️ Überprüfung erforderlich** — mindestens eine Regel konnte nicht automatisch ausgewertet werden
- **❌ Wahrscheinlich nicht zulässig** — eine oder mehrere Regeln sind eindeutig nicht erfüllt
