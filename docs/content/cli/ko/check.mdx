...
```
✅ my-project — MIT · 별 412개 · 마지막 푸시 3일 전

48개 프로그램 자격 요건 — 12개 적격, 8개 검토 필요, 28개 부적격
  ...
  ❌  DigitalOcean Open Source Credits             부적격 가능성 높음 — GitHub 별이 충분하지 않음
```

상태:

- **✅ 적격 가능성 높음** — 분석된 모든 자격 규칙이 일치함
- **⚠️ 검토 필요** — 최소 하나의 규칙을 자동으로 평가할 수 없음
- **❌ 부적격 가능성 높음** — 하나 이상의 규칙이 명백히 일치하지 않음

신청하기 전에 항상 프로그램의 공식 페이지에서 확인하세요.
